...
Currently Mapflow provides two pricing models: pay-as-you-go and subscription plans. Currently the plans **"Mapflow Premium"** and **"Mapflow Starter"** are available.
...
.. note::
   1. Using the Mapflow subscription plan one can buy additional credits with pay-as-you-go pricing.
   2. To activate the subscription, go to your `account profile - Balance <https://app.mapflow.ai/account/balance>`_ and choose the Mapflow subscription plan.
   3. To deactivate the subscription, go to your `account profile - Balance <https://app.mapflow.ai/account/balance>`_ and turn off the Mapflow subscription plan.
